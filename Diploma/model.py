...
class EconModel():
    def __init__(self, dataset):
        ...
        self.aggregated_data_df['W_X'] = (self.aggregated_data_df['W_X_part']/100)*self.aggregated_data_df['Y_X']
        self.aggregated_data_df['dW_X'] = np.diff(self.aggregated_data_df['W_X'], append = self.aggregated_data_df['W_X'][-1 : ])
        #self.aggregated_data_df['Q_K'] = self.aggregated_data_df['W_L_spendings'] + self.aggregated_data_df['W_G_spendings']
    ...
    def CreateDatasets(self):
        ...
        self.Q_X_Dataset = self.Q_X_Dataset[ : -10]
        ...
        self.Q_K_Dataset = self.Q_K_Dataset[ : -10]
        ...
        self.Q_L_Dataset = self.Q_L_Dataset[ : -10]
        ...
        self.W_X_Dataset = self.W_X_Dataset[ : -10]
        ...
        self.Z_X_Dataset = self.Z_X_Dataset[ : -10]
        ...
        for label in [x for x in self.parameters if x not in ['target', 'b_L_XL', 'b_L_GL', 'b_M_LO', 'b_X_LX', 'b_Z_XB']]:
            self.W_L_Dataset[label] = 0
        self.W_L_Dataset['label'] = "W_L_Dataset"
        self.W_L_Dataset = self.W_L_Dataset[ : -10]  
        ...
        self.W_G_Dataset = self.W_G_Dataset[ : -10]   
        ...
        self.R_Dataset = self.R_Dataset[ : -10]
